...
| ID | Zustand | Kern |
|---|---|---|
| SCR-00 | Closed | App inaktiv, Menu-Bar-Icon, globaler ⌘-Listener |
| SCR-01 | Overlay Default | Reiter Git, Auswahl Zeile 1, Gruppen sichtbar |
...
## MUSS (v1.0)
- M1 ⌘ exakt allein ≥ 0,6 s gehalten öffnet das Overlay; Loslassen schließt es. ⌘+weitere Taste (⌘C, ⌘Tab, …) öffnet es NICHT; System-Shortcuts bleiben unberührt (Events nie schlucken).
- M2 Menu-Bar-App ohne Dock-Icon; Menü mit mindestens: Overlay testweise öffnen, Berechtigungsstatus, Beenden.
...
- M6 Tastatur: ↑↓ Auswahl über Gruppengrenzen mit Mitscrollen; Start immer Zeile 1; ⌘1–4 direkt; ←→ zyklisch; ⌘C/⌃C kopiert Auswahl; esc verlässt ein Editierfeld.
